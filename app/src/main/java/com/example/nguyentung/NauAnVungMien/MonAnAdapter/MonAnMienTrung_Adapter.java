...
public class MonAnMienTrung_Adapter extends RecyclerView.Adapter<MonAnMienTrung_Adapter.MyViewHolder> {

    private ArrayList<ThongTinMonAn> lsData;
    private Context mContext;

    public MonAnMienTrung_Adapter(ArrayList<ThongTinMonAn> lsData, Context context) {
        this.lsData = lsData;
