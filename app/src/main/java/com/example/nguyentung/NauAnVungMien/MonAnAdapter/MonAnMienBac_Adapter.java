...
public class MonAnMienBac_Adapter extends RecyclerView.Adapter<MonAnMienBac_Adapter.MyViewHolder> {

    private ArrayList<ThongTinMonAn> lsData;
    private Context mContext;

    public MonAnMienBac_Adapter(ArrayList<ThongTinMonAn> lsData, Context context) {
        this.lsData = lsData;
