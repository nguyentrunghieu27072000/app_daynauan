...
public class MonAnMienTay_Adapter extends RecyclerView.Adapter<MonAnMienTay_Adapter.MyViewHolder> {

    private ArrayList<ThongTinMonAn> lsData;
    private Context mContext;

    public MonAnMienTay_Adapter(ArrayList<ThongTinMonAn> lsData, Context context) {
        this.lsData = lsData;
